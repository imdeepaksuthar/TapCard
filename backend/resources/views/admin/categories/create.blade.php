<x-admin.layout>
    <x-slot name="title">Add New Category | Card Setu Admin</x-slot>
            ...
            <div class="p-6.5">
                <div class="mb-4.5 flex flex-col gap-6 sm:flex-row">
                    <div class="w-full sm:w-1/2">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Enter category name" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary @error('name') border-[#EB5757] @enderror" required>
                    ...
                    <div class="w-full sm:w-1/2">
                        ...
                        <input type="text" name="type" value="{{ old('type') }}" placeholder="e.g., Business, Personal, Social..." class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary @error('type') border-[#EB5757] @enderror">
                        @error('type')
                            <p class="mt-1 text-sm text-[#EB5757]">{{ $message }}</p>
                        @enderror
                    </div>
