        ...
        <form action="{{ route('admin.advertisings.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="p-6.5">
                ...
                <div class="mb-4.5">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" placeholder="Enter campaign title"
                ...
                <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                    <div class="w-full xl:w-1/2">
                        ...
                        <select name="position"
                            ...
                            required>
                            <option value="top" {{ old('position') == 'top' ? 'selected' : '' }}>Top (Leaderboard ·
                                728×90)</option>
                            <option value="right" {{ old('position') == 'right' ? 'selected' : '' }}>Right (Skyscraper ·
                                300×600)</option>
                            <option value="bottom" {{ old('position') == 'bottom' ? 'selected' : '' }}>Bottom (Medium
                                Rectangle · 300×250)</option>
                        </select>
                        @error('position')
                            <p class="text-meta-1 text-sm mt-1">{{ $message }}</p>
                        @enderror
