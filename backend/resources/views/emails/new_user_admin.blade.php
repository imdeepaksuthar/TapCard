...
<body>
    <div class="container">
        <div class="card">
            ...
            <p>A new user has just registered and verified their email address on Card Setu.</p>
            ...
            <div class="panel">
                ...
                @endif
                <p style="margin: 0;"><strong>Registered At:</strong> {{ $user->created_at->format('M d, Y h:i A') }}</p>
            </div>
            
            <div class="btn-wrapper">
                <a href="{{ url('/admin/users') }}" class="btn">View User in Dashboard</a>
            </div>

            <div class="divider"></div>
            <p class="footer-text">&copy; {{ date('Y') }} Card Setu System Alert.</p>
        </div>
    </div>
</body>
</html>
